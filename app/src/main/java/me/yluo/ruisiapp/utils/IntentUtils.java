...
public class IntentUtils {
    ...
    public static void sendMail(Context activity, String username) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        Uri to = Uri.parse("mailto:2022109678@qq.com");
        intent.setData(to);
        intent.putExtra(Intent.EXTRA_SUBJECT, "苏信邦bug反馈 " + username);
    ...
    public static void shareApp(Context context, String data) {
        ...
        context.startActivity(Intent.createChooser(shareIntent, "分享到苏信邦到:"));
    }
}
