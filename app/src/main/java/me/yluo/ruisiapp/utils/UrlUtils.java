...
public class UrlUtils {
    ...
    public static String getAvaterurls(String urlUid) {
        ...
        return App.getBaseUrl() + "uc_server/avatar.php?uid=" + uid + "&size=small";
    }
    ...
    public static String getAvaterurlm(String urlUid) {
        ...
        return App.getBaseUrl() + "uc_server/avatar.php?uid=" + uid + "&size=middle";
    }
    ...
    public static String getAvaterurlb(String urlUid) {
        ...
        return App.getBaseUrl() + "uc_server/avatar.php?uid=" + uid + "&size=big";
    }
